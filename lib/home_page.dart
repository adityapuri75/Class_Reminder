...
class _HomePageState extends State<HomePage> {
  ...
  var date = DateFormat("M-dd-yyyy").format(DateTime.now());
  var date1 =
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                       ...
                                       var datatime1 =  datatime.substring(datatime.indexOf("-")+1,datatime.length);
                                        var x = datatime1.substring(0, datatime1.indexOf(':'));
                                       var x1 = datatime1.substring(datatime1.indexOf(":")+1,datatime1.indexOf(" "));
                                      ...
                                      var xx= double.parse(x);
                                       ...
                                       var timetabletime = xr;
                                        ...
                                        var z = datatime1.substring(datatime1.indexOf(" ")+1,datatime1.length);
